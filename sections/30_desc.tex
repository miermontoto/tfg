...
\begin{enumerate}
	\item \textbf{Okticket:} la empresa es la principal parte interesada en el
		...
		\begin{itemize}
			...
			% \item \textbf{Negocio:} afectado porque permitirá tomar mejores
			% 	decisiones estratégicas, definir y seguir métricas de
			...
			% 	\ldots
			% \item \textbf{Operaciones:} afectado porque les permitirá hacer un
			% 	mejor seguimiento de las operaciones y procesos de la empresa.
		\end{itemize}
