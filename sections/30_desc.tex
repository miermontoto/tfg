...
% \subsection{Componentes del sistema}\label{sec:componentes}
...
% \paragraph{Tópico}\label{subsec:topico}
...
% \paragraph{Productor}\label{subsec:productor}
...
% \paragraph{Consumidor}\label{subsec:consumidor}
...
% \paragraph{Broker}\label{subsec:broker}
...
% \paragraph{Zookeeper}\label{subsec:zookeeper}
