...
\begin{itemize}
    \item \textbf{Tópico}: Un tópico es una categoría a la que se envían los
		mensajes a la que los consumidores están \textit{suscritos}. Los
    ...
    \item \textbf{Zookeeper}: Zookeeper es un servicio separado de coordinación
		...
		tópicos. Actualmente, es una dependencia obligatoria.
		~\footnote{
...
Desde el primer momento, desde la empresa se considera a Kafka como la opción
más sólida junto con el \textit{stack ELK} para desarrollar el proyecto, al
...
disponibles, se plantea la siguiente arquitectura:
