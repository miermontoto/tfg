...
compleja, reduciendo los costes de los procesos ETL derivados (ver \fullref{sec:etl}). Esto
...
visualización de datos, como los \textit{dashboards} (ver \fullref{sec:dashboards}), que
