...
\emph{data lake}). % Estás adelantando que va a ser un data lake sin haber dado contexto, 
% opciones y descrito las necesidades en detalle, igual mejor no referirse aún a datalake como solución elegida
...
% Aquí se podría añadir algo de chicha, ¿qué tipos de almacenamiento hay?, ¿enciptar datos?...
% no se si son temas comunes pero es algo que podría ser interesante.
...
que se beneficien del cambio: % No acabo de entender del todo esta frase :pensador:
...
% Los cuadros de mandos , .. , es un termino
% igual mejor en vez de *es un termino ..* poner algo del estilo *son una solución ..*
% o al revés; *dashboard, es un térmio ..*
...
% ¿esto es realmente parte de la sección teórica? igual estaría mejor en la sección de descripción
...
% Lo mismo que lo comentado en la linea 187:
% Estás adelantando que va a ser un data lake sin haber dado contexto, 
% opciones y descrito las necesidades en detalle, igual mejor no referirse aún a datalake como solución elegida.
