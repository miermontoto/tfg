...
\begin{figure}[H]
	\centerline{\includegraphics[width=1.2\textwidth]{infra/aws_infra.png}}
...
\begin{figure}[H]
	\centerline{\includegraphics[width=1.2\textwidth]{infra/aws_seguridad.png}}
...
\begin{figure}[H]
	\centerline{\includegraphics[width=1.2\textwidth]{infra/aws_redes.png}}
