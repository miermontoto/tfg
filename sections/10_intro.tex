...
% Aquí personalmente expondría en primer lugar el problema. Ejemplo para el primer item:
%  - Decisiones de negocio erróneas debidas a un mal tratamiento de los datos:
%		Sin la necesaria automatización...

% Aparte de lo anterior ¿qué es ETL? es la primera mención del tema en el texto y no lo ví en el glosario.
...
% Similar o duplicado de la linea 87, aquí yo comentaría que el crecimiento acelerado de la
% empresa ha generado muchos silos de información que deben ser unificados. Varias soluciones de 
% gestión contable, ventas, consultoría así como en los propios datos que genera Okticket a nivel de solución SaaS 
% (holded, hubspot, pantadoc, freshdesk, bases de datos propias, logs ...)
% (por si no me explico bien; aquí profundizaría en el problema y enfatizaría lo tedioso que es ir a cada fuente para obtener una pequeña parte de la información)
