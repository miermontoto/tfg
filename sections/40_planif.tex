...
estimación sobre la \textit{prioridad} de las mismas, que se representa con % 'con' o 'siguiendo' los dos creo que es incorrecto
...
\begin{itemize}
	...
	\item Adicionalmente, se utiliza un \textit{roadmap} de apartados de la
		...
		% La visualización adecuada de las fechas y demás enlaza con la parte de comunicación efectiva que mencionas previamente.
		% si dejas una pequeña frase indicándolo estarías, además de justificándote, trazando una linea clara entre lo que haces y la teoría ;) 
...
% Del presupuesto tengo poco o nada que decir, no obstante añadiría una indicación relativa a que
% el cose de personal es ficticio pero se ha basado en la experiencia de la empresa contratando y subcontratando trabajadores reales.
