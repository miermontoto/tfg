...
\def\title{Explotación, integración y visualización de múltiples fuentes de datos mediante un Data Lakehouse}
\def\shortTitle{ETL de datos heterogéneos mediante un Data Lakehouse}
